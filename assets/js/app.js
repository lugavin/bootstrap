...
(function (root) {
    ...
    Base.format = format;
    Base.formatString = formatString;
    Base.formatObject = formatObject;
    Base.generateRandomNumber = generateRandomNumber;
    Base.generateGUID = generateGUID;
    Base.ajax = ajax;
    ...
    function ajax(options) {
        ...
        var xmlHttp = root.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
        // 2)向服务器发送请求
